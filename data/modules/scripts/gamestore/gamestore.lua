...
GameStore.Categories = { -- Hardcore Offers
{
    icons = {"Black_Skull.png"},
    name = "Hardcore Offers",
    rookgaard = true,
    state = GameStore.States.STATE_NONE,
    offers = {{
        ...
        id = 44780,
        itemtype = 44780,
        description = "Used to revive yourself or others players.",
        ...
        blessid = 9,
        count = 1,
        description = "<i>Protect your character from permanent death.</i>",
