...
function doCombat(cid, combat, var)
    ...
    logger.warn(
        "Deprecation Warning: The function 'doCombat(cid, combat, var)' is outdated. Please use the new format 'combat:execute(cid, var)'. Update needed at: Line {}, Source: {}.",
        line, source)
...
function isCreature(cid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'isCreature(cid)' is outdated. Please use the new format 'Creature(cid)'. Update needed at: Line {}, Source: {}.",
        line, source)
...
function isPlayer(cid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'isPlayer(cid)' is outdated. Please use the new format 'Player(cid)'. Update needed at: Line {}, Source: {}.",
        line, source)
...
function isMonster(cid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'isMonster(cid)' is outdated. Please use the new format 'Monster(cid)'. Update needed at: Line {}, Source: {}.",
        line, source)
...
function isSummon(cid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'isSummon(cid)' is outdated. Please use the new format 'c:getMaster()', where 'c' refers to a Creature (player or monster). Update needed at: Line {}, Source: {}.",
        line, source)
...
function isNpc(cid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'isNpc(cid)' is outdated. Please use the new format 'Npc(cid)'. Update needed at: Line {}, Source: {}.",
        line, source)
    return Npc(cid) ~= nil
end
...
function isItem(uid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'isItem(uid)' is outdated. Please use the new format 'Item(uid)'. Update needed at: Line {}, Source: {}.",
        line, source)
    return Item(uid) ~= nil
end
...
function isContainer(uid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'isContainer(uid)' is outdated. Please use the new format 'Container(uid)'. Update needed at: Line {}, Source: {}.",
        line, source)
...
function getCreatureName(cid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'getCreatureName(cid)' is outdated. Please use the new format 'c:getName()', where 'c' refers to a Creature (player or monster). Update needed at: Line {}, Source: {}.",
        line, source)
...
function getCreatureHealth(cid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'getCreatureHealth(cid)' is outdated. Please use the new format 'c:getHealth()', where 'c' refers to a Creature (player or monster). Update needed at: Line {}, Source: {}.",
        line, source)
    local c = Creature(cid)
...
function getCreatureMaxHealth(cid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'getCreatureMaxHealth(cid)' is outdated. Please use the new format 'c:getMaxHealth()', where 'c' refers to a Creature (player or monster). Update needed at: Line {}, Source: {}.",
        line, source)
    local c = Creature(cid)
...
function getCreaturePosition(cid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'getCreaturePosition(cid)' is outdated. Please use the new format 'c:getPosition()', where 'c' refers to a Creature (player or monster). Update needed at: Line {}, Source: {}.",
        line, source)
    local c = Creature(cid)
...
function getCreatureOutfit(cid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'getCreatureOutfit(cid)' is outdated. Please use the new format 'c:getOutfit()', where 'c' refers to a Creature (player or monster). Update needed at: Line {}, Source: {}.",
        line, source)
    local c = Creature(cid)
...
function getCreatureSpeed(cid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'getCreatureSpeed(cid)' is outdated. Please use the new format 'c:getSpeed()', where 'c' refers to a Creature (player or monster). Update needed at: Line {}, Source: {}.",
        line, source)
    local c = Creature(cid)
...
function getCreatureBaseSpeed(cid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'getCreatureBaseSpeed(cid)' is outdated. Please use the new format 'c:getBaseSpeed()', where 'c' refers to a Creature (player or monster). Update needed at: Line {}, Source: {}.",
        line, source)
    local c = Creature(cid)
...
function getCreatureTarget(cid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'getCreatureTarget(cid)' is outdated. Please use the new format 'c:getTarget():getId()', where 'c' refers to a Creature (player or monster). Update needed at: Line {}, Source: {}.",
        line, source)
    local c = Creature(cid)
    if c then
...
function getCreatureMaster(cid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'getCreatureMaster(cid)' is outdated. Please use the new format 'c:getMaster():getId()', where 'c' refers to a Creature (player or monster). Update needed at: Line {}, Source: {}.",
        line, source)
    local c = Creature(cid)
    if c then
...
function doCreatureAddHealth(cid, health)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'doCreatureAddHealth(cid, health)' is outdated. Please use the new format 'c:addHealth(health)', where 'c' refers to a Creature (player or monster). Update needed at: Line {}, Source: {}.",
        line, source)
    local c = Creature(cid)
...
function doRemoveCreature(cid)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'doRemoveCreature(cid)' is outdated. Please use the new format 'c:remove()', where 'c' refers to a Creature (player or monster). Update needed at: Line {}, Source: {}.",
        line, source)
    local c = Creature(cid)
...
function doCreatureSetLookDir(cid, direction)
    ...
    local source = debug.getinfo(2).source:match("@?(.*)")
    logger.warn(
        "Deprecation Warning: The function 'doCreatureSetLookDir(cid, direction)' is outdated. Please use the new format 'c:setDirection(direction)', where 'c' refers to a Creature (player or monster). Update needed at: Line {}, Source: {}.",
        line, source)
    local c = Creature(cid)
